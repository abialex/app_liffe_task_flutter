  ...
  Widget build(BuildContext context) {
    return AppResponsiveBase(
        ...
        web: Container(
          ...
          child: TextFormField(
            style: AppConstTextDesktop.body1(text: '').style!,
            controller: controller,
            keyboardType: keyboardType,
            inputFormatters: inputFormatters,
            maxLines: maxLines,
            ...
            decoration: InputDecoration(
              ...
              prefixIconConstraints: const BoxConstraints(),
              contentPadding: EdgeInsets.only(
                bottom: verticalPaddingEnum?.size ?? AppSpacingEnum.medium.size,
                left: leftPaddingEnum?.size ?? AppSpacingEnum.large.size,
                right: rightPaddingEnum?.size ?? AppSpacingEnum.small.size,
                top: verticalPaddingEnum?.size ?? AppSpacingEnum.medium.size,
              ),
              hintText: placeholder,
              hintStyle: AppConstTextDesktop.body1(text: '', color: AppConstColors.grey500).style!,
              isDense: true,
              filled: true,
              fillColor: (enable ?? true) ? AppConstColors.white : AppConstColors.grey200,
              enabledBorder: OutlineInputBorder(
